...
def exercicio_11():
    ...
    # Filtra o log de pacotes e lista instalações com a data[cite: 1]
...
def exercicio_12():
    ...
    # Identifica todos os pacotes que foram removidos do sistema[cite: 1]
...
def exercicio_13():
    ...
    # Rastreia quem executou comandos de pacotes (apt, dpkg) e qual ação foi realizada[cite: 1]
